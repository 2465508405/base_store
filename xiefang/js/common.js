...
window.onload = function(){
	com.bg=new com.class.Bg(); //canvas 背景图
	com.dot = new com.class.Dot(); //dot对象，
	com.pane=new com.class.Pane();//生成ma
...
com.createMans = function(map){
	...
	console.log("com.mans:", com.mans);
	console.log("com.childlist:", com.childList);
}
...
//二维数组克隆
com.arr2Clone = function (arr){//arr :兵卒位置初始化
	var newArr=[];
	for (var i=0; i<arr.length ; i++){
		newArr[i] = arr[i].slice();
	}
	console.log("com.arr2Clone:", newArr);
	return newArr;
}
...
com.class.Man = function (key, x, y){
	...
	this.show = function (){
		if (this.isShow) {
			...
			console.log('图片位置：',com.spaceX, this.x ,com.pointStartX, com.spaceY ,  this.y , com.pointStartY );
			com.ct.restore();
		}
	}
